...
"inviteCode": "mememteeeekkeke","groupName": "Soibot", 
...
alpha.on('group-update', async (anu) => {
	console.log(anu)
falfa = { key: {fromMe: false,participant: "0@s.whatsapp.net",
remoteJid: "0@s.whatsapp.net"},message: {"groupInviteMessage": {"groupJid": "6288213840883-1616169743@g.us","inviteCode": "mememteeeekkeke","groupName": "Soibot", "caption": `Made With ❣️`, 'jpegThumbnail': fs.readFileSync(`image/${setting.thumb}`)}}}
